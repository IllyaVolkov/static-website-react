...
const ProjectsCard = ({ num, title }: CardProps) => {
  return (
...
const Projects = () => {
  return (
    <section className="w-full bg-secondary text-white bg-[url('/work/workbg.png')] bg-cover bg-no-repeat bg-center" id="projects">
      <div className="flex flex-col gap-10 lg:gap-16 container mx-auto md:px-16 px-5 py-12 sm:py-20 md:py-36">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-5">
          <div className="relative">
            <ProjectsCard num="01" title="Set disbursement Instructions" />
            <img
              src={"/work/arrow.svg"}
              width={210}
              height={300}
          ...
          <div className="relative">
            <ProjectsCard num="03" title="Assembly initiates disbursement" />
            <img
              src={"/work/arrow.svg"}
              width={205}
              height={300}
          ...
          <ProjectsCard num="04" title="Customer receives funds payment" />
        </div>
      </div>
    </section>
  );
